...
var host = "34.127.81.127";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "cheesecake-376704:us-west1:cheesecakedb";         //username (change to match your db)
var password = ";LIuNKt|%j6^Qmv+";  //password (change to match your db, yes this is very poor practice)
